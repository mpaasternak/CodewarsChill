...
is running out and the nearest pump is 50 miles away! You know that on average, your car runs on about
25 miles per gallon. There are 2 gallons left. Considering these factors, write a function that tells
...
public class FuelChecker {
    ...
    public static void main(String[] args) {
        ...
        double mpg = 25;
        double fuelLeft = 2;
        System.out.println(zeroFuel(distanceToPump, mpg, fuelLeft));
    }
}
