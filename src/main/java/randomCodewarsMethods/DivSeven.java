...
subtract twice the last digit from the number formed by the remaining digits. Continue to do this until
a number known to be divisible or not by 7 is obtained; you can stop when this number has at most 2 digits
...
public class DivSeven {
    public static long[] seven(long m) {
        ...
        while (m > 99) {
            long nextLong = m % 10;
            m = (m - nextLong) / 10 - 2 * nextLong;
            countSteps++;
        }
        return new long[]{m, countSteps};
    }

    public static void main(String[] args) {
        System.out.println(seven(1603));
    }
}
